...
def history_classes(
    ...
    **base_definition,
    ...
    for m in model_class:
        v = history(
            m, class_module_name=class_module_name or target_name, **base_definition
        )
        r += (v,)
    return r
...
def gen_class(
    ...
    **params,
    ...
    view_class_name = (
        params.pop("view_class_name", None) or f"{crud_name}{parent_class_name}"
    )

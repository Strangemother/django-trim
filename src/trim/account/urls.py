...
urlpatterns = t_urls.paths_named(views,
    ...
    edit=('ProfileUpdateView', 'profile/edit/',),
    edit_username=('ProfileUsernameUpdateView', 'profile/edit/username/',),
    edit_password=('ProfilePasswordUpdateView', 'profile/edit/user-information/',),
    edit_email=('ProfileEmailUpdateView', 'profile/edit/email/now/',),
    edit_email_verified=('VerifiedEmailUpdateView', 'profile/edit/email/',),

    # home=('ProfileView', '',),
    logout=('ProfileLogout', 'logout/',),
    login=('ProfileLogin', 'login/',),

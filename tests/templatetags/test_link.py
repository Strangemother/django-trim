...
class TestLinkTemplateTags(unittest.TestCase):
    ...
    def test_link(self, mock_gen_link):
        ...
        mock_gen_link.return_value = {'url': 'http://example.com', 'text': 'text', 'kwargs': {}}
    ...
    def test_link_shadowdict(self, mock_gen_link):
        ...
        link = link_tags.ShadowDict({'url': 'http://example.com', 'text': 'shadow owl', 'kwargs': {}})
    ...
    def test_url_link(self, mock_gen_link):
        ...
        mock_gen_link.assert_called_once_with('http://example.com', url='http://example.com')
        self.assertEqual(res['url'], 'http://example.com')

"""
This file is specifically designed to read the `trim.models.fields.django` module
and iterate all assets, producing the `models/fields-auto.md`.

IT serves as an example of the first-pass at parsing the tool and probably won't
work on some elses desk.

Issues:

+ Too manual
+ hard to disect
+ Imports a django app
